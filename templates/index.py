...
__CHEETAH_genTime__ = 1271047116.727524
__CHEETAH_genTimestamp__ = 'Mon Apr 12 04:38:36 2010'
__CHEETAH_src__ = 'index.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Apr 12 04:38:26 2010'
...
\t<a id="search" href="#">Search again</a>
      </div>
      <div id="featureVideo">
      </div>
...
\tFB.init("''')
        _v = VFFSL(SL,"config.FB_API_KEY",True) # u'$config.FB_API_KEY' on line 41, col 11
        if _v is not None: write(_filter(_v, rawExpr=u'$config.FB_API_KEY')) # from line 41, col 11.
